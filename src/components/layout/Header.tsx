...
const Header: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Top Bar */}
      <div className="bg-[#2f3a87] text-white py-1.5 text-sm">
        <div className="container-custom flex flex-wrap justify-between items-center px-3">
      ...
      {/* Main Navigation */}
      <nav className="py-3 bg-[#2f3a87]">
        <div className="container-custom flex justify-between items-center px-3">
          <Link to="/" className="flex-shrink-0 transform hover:scale-105 transition-transform mr-4" onClick={closeMenu}>
            <Logo color="white" />
          </Link>
          ...
          <Link to="/admission-inquiry.html" className="hidden lg:inline-flex btn bg-white text-[#2f3a87] font-medium shadow-soft hover:shadow-lg text-sm px-4 py-2 ml-4">
            Apply Now
          </Link>
