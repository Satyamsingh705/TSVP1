              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-700 mb-6">
                    Welcome to Takshashila Vidyapith, where we believe in nurturing not just academic excellence, but the overall development of our students. Our commitment is to provide a learning environment that encourages curiosity, creativity, and character building.
                  </p>
                  <p className="text-gray-700 mb-6">
