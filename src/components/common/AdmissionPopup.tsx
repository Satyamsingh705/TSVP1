        ...
        <div className="p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Join Takshashila Vidyapith for a transformative educational journey. Apply now to secure your child's future with our comprehensive curriculum and experienced faculty.
            </p>
          </div>
