...
const facultyMembers: FacultyMember[] = [
  {
    ...
    bio: 'Dr. Prasad has over 25 years of experience in the field of education. He has been instrumental in shaping the vision and growth of Takshashila Vidyapith since its inception. His focus on maintaining high academic standards while ensuring holistic development of students has been the cornerstone of the school\'s philosophy.'
  },
  {
    id: 2,
...
const FacultyPage: React.FC = () => {
  useEffect(() => {
    document.title = 'Faculty - Takshsasila vidyapith';
  }, []);
